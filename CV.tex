...
\textbf{98烂坑风控与可视化作战平台} \hfill 2025.08 -- 至今 \titlebreak
...
\begin{itemize}
    ...
    \item 2026年美国大学生数学建模竞赛H奖(Honorable Mention) \hfill 2026.2
\end{itemize}
    
\section{\makebox[\widthof{\faInfo}][c]{\color{CVBlue}\faInfo}\ 其他}
\begin{itemize}[parsep=0.5ex]
    \item \textbf{英语水平：} TOFEL 110, CET-4 605, CET-6 602
    \item \textbf{交流经历：} 不列颠哥伦比亚大学暑期课程项目（数据科学方向） \hfill 2025.7-2025.8
\end{itemize}
\end{document}
